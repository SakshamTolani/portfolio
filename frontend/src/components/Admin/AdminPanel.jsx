...
import { getUser, loadUser, logout, updateUser } from "../../actions/user";
          ...
          <div className="adminPanelAbout">
            <fieldset>
              ...
              <input
                ...
                defaultValue={user.about.subtitle}
                onChange={(e) =>
              ...
              <input
                ...
                defaultValue={user.about.description}
                onChange={(e) =>
